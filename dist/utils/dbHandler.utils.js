...
var mongoServer = mongodb_memory_server_1.MongoMemoryServer.create();
var dbConnect = function () { return __awaiter(void 0, void 0, void 0, function () {
    var uri, mongooseOpts;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mongoServer];
            case 1:
                uri = (_a.sent()).getUri();
                mongooseOpts = {
...
var dbDisconnect = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, mongoServer];
            case 3: return [4 /*yield*/, (_a.sent()).stop()];
            case 4:
                _a.sent();
                return [2 /*return*/];
        }
